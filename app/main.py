...
def add_predictions(input_data):
    ...
    # Create a DataFrame for valid feature names
...
def show_disclaimer():
    if st.session_state.get('show_disclaimer', True):
        st.warning("Disclaimer: This application provides insights based on machine learning predictions, but it may yield inaccurate results as it is trained on specific datasets. It is essential to consult qualified medical professionals for an accurate diagnosis and treatment recommendations. Always rely on professional judgment and clinical evaluations.")
        # Close button below the disclaimer
...
def main():
    st.set_page_config(
        page_title="Benign or Malignant",
    ...
    show_disclaimer()  # Show disclaimer when app starts
    
    input_data = add_sidebar()
    
    with st.container():
        st.markdown("<h1 style='color: #4A90E2;'>Benign or Malignant</h1>", unsafe_allow_html=True)
